...
export default function AgentsTargetsRedirectPage() {
  const router = useRouter();

  useEffect(() => {
    // Redirect to Strategic Planning with advisor view and goals tab
    router.replace('/strategic-planning?tab=goals&view=advisor');
  }, [router]);
          ...
          <div className="flex items-center justify-center py-12">
            <div className="text-center">
              ...
              <p className="text-sm text-slate-500 mt-2">
                Agents Targets has been consolidated into Strategic Planning
              </p>
            </div>
          </div>
        </div>
